		...
		<section id="registration">
			<div class="container">
				...
				<div class="breadcrumb">
					<a href="index.php">TOP</a><i class="fa-solid fa-angle-right"></i><a href="./main-registration-form.php">会員登録（入力）</a><i class="fa-solid fa-angle-right"></i><a href="./main-registration-confirm.php">会員登録（確認）</a><i class="fa-solid fa-angle-right"></i><span>会員登録（完了）</span>
				</div>
				<div class="container-box">
					<h3 class="complete-text">会員登録が完了いたしました。</h3>
				</div>
			</div>
		</section>
		<!-- 	/会員登録 -->
