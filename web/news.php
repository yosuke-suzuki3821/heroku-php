    ...
    <?php include('./header.php'); ?>
		...
		<section id="news">
			<div class="container">
				...
				<div class="breadcrumb">
					<a href="index.php">TOP</a><i class="fa-solid fa-angle-right"></i><span>お知らせ一覧</span>
				</div>
				<div class="container-box">
					<ul class="news-inner">
						<li>
							<ul class="flex-block tag">
								<li><p class="date">2018.11.06</p></li>
								<li><p class="category">カテゴリカテゴリカテゴリ</p></li>
							</ul>
							<a href="./news-details.php"><p class="title">テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト</p></a>
						</li>
						<li>
							<ul class="flex-block">
								<li><p class="date">2018.11.06</p></li>
								<li><p class="category">カテゴリ</p></li>
							</ul>
							<a href="./news-details.php"><p class="title">テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト</p></a>
						</li>
						<li>
		...
		<section id="registration">
			<div class="container">
				...
				<div class="btn">
					<a class="btn-mstd" href="">Register now</a>
				</div>
			</div>
		</section>
		<!-- 	/会員登録 -->
